...
# ----- Dataset folder path -----
dataset_path = "./detasetac"  # tman specify your dataset path here (folder containing 'normal' and 'cataract')
...
for r, d, f in os.walk(os.path.join(dataset_path, 'acne')):
    for file in f:
