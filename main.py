...
# ----- Dataset folder path -----
dataset_path = "./dataset"  # tman specify your dataset path here (folder containing 'normal' and 'cataract')
...
for r, d, f in os.walk(os.path.join(dataset_path, 'cataract')):  # tman
    for file in f:
...
model.save('cataract_model.h5')  # tman
print("✅ cataract_model.h5")
