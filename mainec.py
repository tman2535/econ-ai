...
# ----- Dataset folder path -----
dataset_path = "./detasetec"  # tman specify your dataset path here (folder containing 'normal' and 'cataract')
...
for r, d, f in os.walk(os.path.join(dataset_path, 'eczema')):
    for file in f:
...
model.save('eczema_model.h5')  # tman
print("✅ eczema_model.h5")
