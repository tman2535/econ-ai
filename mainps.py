...
# ----- Dataset folder path -----
dataset_path = "./detasetps"  # tman specify your dataset path here (folder containing 'normal' and 'cataract')
...
for r, d, f in os.walk(os.path.join(dataset_path, 'Psoriasis')):
    for file in f:
...
model.save('Psoriasis_model.h5')  # tman
print("✅ Psoriasis_model.h5")
