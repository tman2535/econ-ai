...
# ----- Dataset folder path -----
dataset_path = "./datasetst"  # tman specify your dataset path here (folder containing 'normal' and 'cataract')
...
for r, d, f in os.walk(os.path.join(dataset_path, 'strabismus')):  # tman
    for file in f:
...
model.save('strabismus_model.h5')  # tman
print("✅ strabismus_model.h5")
...
# ----- Save model -----
model.save('strabismus_model.h5')
