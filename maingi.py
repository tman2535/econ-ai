...
# ----- Dataset folder path -----
dataset_path = "./detasetgi"  # tman specify your dataset path here (folder containing 'normal' and 'cataract')
...
for r, d, f in os.walk(os.path.join(dataset_path, 'Gingivitis')):
    for file in f:
...
model.save('Gingivitis_model.h5')  # tman
print("✅ Gingivitis_model.h5")
...
# ----- Save model -----
model.save('Gingivitis_model.h5')
